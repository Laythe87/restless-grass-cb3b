...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/restless-grass-cb3b#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-grass-cb3b
```

A live public deployment of this template is available at [https://restless-grass-cb3b.templates.workers.dev](https://restless-grass-cb3b.templates.workers.dev)
